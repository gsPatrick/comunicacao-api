...
const seedFromExcel = async ({ transaction }) => {
  ...
  // Garante que só processaremos linhas que tenham pelo menos as colunas essenciais.
  ...
  // O restante do script agora pode operar com segurança, sabendo que os dados são válidos
